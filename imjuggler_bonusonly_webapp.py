# -*- coding: utf-8 -*-
"""Imjuggler_bonusonly_Webapp.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XOQP5v6AklVXGtR9gwi7VLzBUype_x3-
"""
...
st.title("アイムジャグラーEX 設定判別アプリ (2値分類)")
st.markdown("入力されたデータから、設定が「低中設定(1-3)」か「高中設定(4-6)」かを予測します。")

# ★★★ 学習済みモデルのファイルパスを指定 ★★★
MODEL_FILE_PATH = 'Imjuggler_binary_classifier_bonusonly_tuned.joblib' # ご自身のモデルファイル名に変更
